function [result, indexes]=multigraph(X,s,alpha,beta,gamma)
...
res=zeros(10,3);
for ij=1:1
indexes= kmeans(F, c, 'emptyaction', 'singleton', 'replicates', 1, 'display', 'off');
[res(ij,:)] = ClusteringMeasure( indexes,s);
end
