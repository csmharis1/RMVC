function [F, P, R, nmi, avgent, AR ,myresults] = spectral_centroid_multiview(X,num_views,numClust,sigma,lambda,truth,numiter)
% INPUT:
% OUTPUT:
    ...
    for j=1:kmeans_avg_iter
        ...
        myresultsj(j,:) =ClusteringMeasure1(truth, C);
    end
